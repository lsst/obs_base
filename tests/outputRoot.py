...
class OutputRootTestCase(unittest.TestCase):
    ...
    def testBackup(self):
        ...
        b1Check = pickle.load(open(os.path.join(testOutput2, "foo-1,1.pickle~2")))
        b2Check = pickle.load(open(os.path.join(testOutput2, "foo-1,1.pickle~1")))
        b3Check = pickle.load(open(os.path.join(testOutput2, "foo-1,1.pickle")))
